...
Nova.booting(function (Vue, router, store) {
  Vue.component('index-laravel-nova-morph-many-to-one', __webpack_require__(3));
  Vue.component('detail-laravel-nova-morph-many-to-one', __webpack_require__(6));
  Vue.component('form-laravel-nova-morph-many-to-one', __webpack_require__(9));
});
